...
#define EXPV_EVAPORATOR_COOLANT 1
#define EXPV_EVAPORATOR_CABIN 2
#define EXPV_EVAPORATOR_RECIRC 3
#define EXPV_CONDENSOR_COOLANT 4
#define EXPV_CONDENSOR_CABINL 5
#define EXPV_CONDENSOR_CABINR 6
